...
$htmls = curl_request('http://www.trackdota.com/data/game/3263237743/live.json',array(),'GET',true);
$live_data = json_decode($htmls,true);

echo "<pre>";var_dump($live_data);exit;
