...
require_once("./libverfiy/alipay_notify.class.php");
...
if($verify_result) {//验证成功
    ...
    if($_POST['trade_status'] == 'TRADE_FINISHED') {
        ...
        //logResult("这里写入想要调试的代码变量值，或其他运行的结果记录");
    	//运行商户的程序代码
		$verfiy_url = 'http://api.aifamu.com/index.php?g=api&m=pay&a=alipaycallback'; //支付宝支付的处理url
		$request_url = $verfiy_url . '&' . http_build_query($data);
		// file_put_contents('./1234.txt', $request_url);
