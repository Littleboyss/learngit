...
<div class="subnav">
    ...
    <a href='javascript:;' class="on"><em>修改队伍</em></a>
    <span>|</span>
        ...
        <form method="post" id="form1" action="<?php echo U('edit');?>">
                ...
                <table width='98%' border='0' cellpadding='0' cellspacing='0'
                    ...
                    <tr>
                        ...
                        <td class="tLeft" colspan="3">
                            <input type="text" name="short_name" value="<?php echo ($data["short_name"]); ?>" class="sm input-text" />
                        </td>
                    </tr>
                    <tr>
                        <td class="tRight">teamid：</td>
                        <td class="tLeft" colspan="3">
                            <input type="text" name="code" value="<?php echo ($data["code"]); ?>" class="sm input-text" />
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td class="tLeft" colspan="3">
                            <select name="union">
                                ...
                                <?php if(is_array($union)): $i = 0; $__LIST__ = $union;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$rs): $mod = ($i % 2 );++$i;?><option value="<?php echo ($key); ?>" <?php if($key == $data['union']): ?>selected="selected"<?php endif; ?>><?php echo ($rs); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
                            </select>
                        </td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td class="tLeft" colspan="3">
                            <select name="location">
                                <option value="0">无</option>
                                <?php if(is_array($location)): $i = 0; $__LIST__ = $location;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$rs): $mod = ($i % 2 );++$i;?><option value="<?php echo ($key); ?>" <?php if($key == $data['location']): ?>selected="selected"<?php endif; ?>><?php echo ($rs); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
                            </select>
                        </td>
                    </tr>
