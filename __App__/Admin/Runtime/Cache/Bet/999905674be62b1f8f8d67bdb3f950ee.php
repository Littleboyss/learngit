...
<div class="subnav">
  <div class="content-menu ib-a blue line-x"> 
    <a href='javascript:;' class="on"><em>球员新闻列表</em></a>
    <span>|</span><a href="<?php echo U('news_add');?>"><em>添加新闻</em></a> </div>
  </div>
</div>
<div class="pad_10">
  ...
  <thead>
    ...
    <th align="center">项目</th>
		<th align="center">球员id</th>
    <th align="center">球员名称</th>
  ...
  <?php if(is_array($data)): foreach($data as $key=>$vo): ?><tr align='left'>
      ...
      <td width="200" align="center"><?php echo ($vo[player_id]); ?></td>
      ...
      <td width="20%" align="center">
          <a href="<?php echo U('news_edit', array('id' => $vo['id']));?>">修改</a>
          &nbsp;
          <a href="<?php echo U('news_del', array('id' => $vo['id']));?>" >删除</a>
          &nbsp;
      </td>
