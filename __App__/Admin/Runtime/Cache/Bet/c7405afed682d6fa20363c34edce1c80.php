...
<div class="subnav">
  <div class="content-menu ib-a blue line-x"> <a href='javascript:;' class="on"><em>赛事列表</em></a>
    <span>|</span><a href="<?php echo U('matchadd');?>"><em>添加赛事</em></a> </div>
  </div>
</div>
<div class="pad_10">
  ...
  <?php if(is_array($data)): foreach($data as $key=>$vo): ?><tr align='left'>
      ...
      <td width="20%" align="center">
          <a href="<?php echo U('matchedit', array('id' => $vo['id']));?>">修改</a>
          &nbsp;
          <a href="<?php echo U('matchdel', array('id' => $vo['id']));?>" onclick="return confirm('你确定删除吗？')">删除</a>
      </td>
