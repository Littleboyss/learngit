...
<div class="subnav">
  <div class="content-menu ib-a blue line-x"> <a href='javascript:;' class="on"><em>队伍列表</em></a>
    <span>|</span><a href="<?php echo U('add');?>"><em>添加队伍</em></a> </div>
  </div>
</div>
<div class="pad_10">
    ...
    <tr>
      ...
      <td width='230'>
          ...
          <select name="id" id="team" >
              <option value="">所有</option>
              <?php if(is_array($team)): $i = 0; $__LIST__ = $team;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$rs): $mod = ($i % 2 );++$i;?><option value="<?php echo ($rs['id']); ?>" <?php if($rs['id'] == $id): ?>selected="selected"<?php endif; ?>><?php echo ($rs["name"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
          </select>
      </td>
       <td>
  ...
  <?php if(is_array($data)): foreach($data as $key=>$vo): ?><tr align='left'>
      ...
      <td width="200" align="center"><?php echo ($vo["name"]); ?></td>
