                ...
                <table width='98%' border='0' cellpadding='0' cellspacing='0'
                   ...
                   <tr>
                    ...
                    <tr>
                        ...
                        <td class="tLeft" colspan="3">
                            <input type="text" name="only_id" value="<?php echo ($data["only_id"]); ?>" class="sm input-text" />
                        </td>
                    </tr>
                    <tr>
                   ...
                   <tr>
                        ...
                        <td class="tLeft" colspan="3">
                        <input type="text" name="nationality" value="<?php echo ($data["nationality"]); ?>" class="sm input-text" />
                    </td>
                    </tr>
                    ...
                    <tr id="position">
                        ...
                        <td class="tLeft" colspan="3">
                            <?php ; ?>
                            <input type="radio" name="position" value="1" <?php if($data['position'] == 1): ?>checked="checked"<?php endif; ?> />上路　
                            <input type="radio" name="position" value="2" <?php if($data['position'] == 2): ?>checked="checked"<?php endif; ?> />打野
                            <input type="radio" name="position" value="3" <?php if($data['position'] == 3): ?>checked="checked"<?php endif; ?> />中路
                            <input type="radio" name="position" value="4" <?php if($data['position'] == 4): ?>checked="checked"<?php endif; ?> />ADC
                            <input type="radio" name="position" value="5" <?php if($data['position'] == 5): ?>checked="checked"<?php endif; ?> />辅助
                            <input type="radio" name="position" value="6" <?php if($data['position'] == 6): ?>checked="checked"<?php endif; ?> />团队
...
change_position(<?php echo ($data['project_id']); ?>);
...
$(function(){
    var position = <?php echo ($data['position']); ?>;
