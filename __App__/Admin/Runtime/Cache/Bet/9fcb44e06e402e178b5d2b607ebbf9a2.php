    ...
    <div class="table-list">
        <form method="post" id="form1" action="<?php echo U('edit');?>">
                ...
                <table width='98%' border='0' cellpadding='0' cellspacing='0'
                    ...
                    <tr>
                        <td class="tRight">标签图：</td>
                        <td class="tLeft" colspan="3">
                            <input type="text" class="large iptxt" id="icot" name="tag_img" value="<?php echo ($data["tag_img"]); ?>" style="margin-top: 3px"> 
                            <input type="button" id="wqicot" value="上传图片">
                        </td>
                    </tr>
