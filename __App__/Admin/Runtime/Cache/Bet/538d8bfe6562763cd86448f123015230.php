...
<div class="pad_10">
  ...
  <?php if(is_array($data)): foreach($data as $key=>$vo): ?><tr align='left'>
      ...
      <td width="200" align="center"><?php echo ($vo[only_id]); ?></td>
      ...
      <td width="20%" align="center">
          ...
          &nbsp;
         <!--  <a onclick="return confirm('请确定该比赛是否添加正确了？')" target="_blank" href="<?php echo U('add_match_player_info', array('match_id' => $vo['id'],'project_id'=>4));?>" >添加比赛初始数据</a>
          &nbsp; -->
          <a href="<?php echo U('Bet/Update/update_match',array('match_id' => $vo['id']));?>" target="_blank">更新实时数据</a>
      </td>
