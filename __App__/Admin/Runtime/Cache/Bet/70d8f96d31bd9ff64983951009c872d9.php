            ...
            <input name="id" type="hidden" value="<?php echo ($data["id"]); ?>" />
                <table width='98%' border='0' cellpadding='0' cellspacing='0'
                    ...
                    <tr hidden class="type_id">
                        ...
                        <td class="tLeft" colspan="3">
                            <input type="radio" name="is_special" value="1"  <?php if($data['is_special'] == 1): ?>checked="checked"<?php endif; ?>  />是
                            <input type="radio" name="is_special" value="2" <?php if($data['is_special'] == 2): ?>checked="checked"<?php endif; ?> />否
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td class="tLeft" colspan="3">
                            <select name="lineup_id" id="lineup_id">
                                ...
                                <?php if(is_array($lineup)): $i = 0; $__LIST__ = $lineup;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$rs): $mod = ($i % 2 );++$i;?><option value="<?php echo ($key); ?>" <?php if($data['lineup_id'] == $key): ?>selected<?php endif; ?>><?php echo ($rs); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
                            </select>
                        </td>
                    </tr>
                    ...
                    <tr hidden id="show_prize_num">
                        ...
                        <td class="tLeft" colspan="3">
                            <input type="text" name="prize_num" value="<?php echo ($data['prize_num']); ?>" class="huge iptxt sm"   />百分比
                        </td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td class="tLeft" colspan="3">
                            <input type="text" name="allow_guess_num" value="<?php echo ($data["allow_guess_num"]); ?>" class="huge iptxt sm" />
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td class="tLeft" colspan="3">
                            <input type="text" name="match_start_time" value="<?php echo (date("Y-m-d H:i",$data["match_start_time"])); ?>" class="huge iptxt" id="mstime" />
                    ...
                    <tr>
                        ...
                        <td class="tLeft" colspan="3">
                            <input type="text" name="match_end_time" value="<?php echo (date("Y-m-d H:i",$data["match_end_time"])); ?>" class="huge iptxt" id="abort_date" />
                    ...
                    <tr>
                       ...
                       <td class="tLeft" colspan="3">
                           <input type="text" name="end_time" value="<?php echo (date("Y-m-d H:i",$data["end_time"])); ?>" class="huge iptxt" id="abort_date1" />
...
var project_id = <?php echo ($data['project_id']); ?>;
get_match_list(project_id);
            ...
            if(e.error == 0){
                $.each(e.match_list,function(index, el) {
                    ...
                    $.each(el,function(i, item) {
                        ...
                        html += '<td class="tRight">'+item['match_time']+'<input class="check_'+index+'" type="checkbox" value="'+item['id']+'" name="match_team[]"';
                        if ($.inArray( item['id'], e.match ) > -1) {
                            html += 'checked';
                        }
                        html +='><img style="width:15px" src="'+item['a_img']+'">'+item['a_name']+'——'+item['b_name']+'<img style="width:15px" src="'+item['b_img']+'"></td>';
                         if (item['id']%3 == 0) {
                            html += '</tr>';
                        }
                    })
