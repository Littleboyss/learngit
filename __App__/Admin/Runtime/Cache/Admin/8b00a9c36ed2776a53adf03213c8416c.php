...
<div class="subnav">
  <div class="content-menu ib-a blue line-x"> <a href='javascript:;' class="on"><em>活动码</em></a>
  <span>|</span><a href="<?php echo U('addCode');?>"><em>去生成</em></a>
    　
  </div>
</div>
<div class="pad_10">
  ...
  <thead>
    ...
    <?php if(is_array($data)): foreach($data as $key=>$vo): ?><tr align='left'>
      ...
      <td align="center" <?php if($vo[type] == 1): ?>style="color:blue;"<?php else: ?>style="color:green;"<?php endif; ?>><?php echo ($menu[$vo[type]]); ?></td>
      <td align="center"><?php if($vo[status] == 1): ?>未领取<?php else: ?><span style="color:red;">已领取</span><?php endif; ?></td>
      <td align="center"><?php if($vo[get_time] == 0): ?>暂无<?php else: echo (date("y-m-d H:i",$vo["get_time"])); endif; ?></td>
      <td align="center"><?php if($vo[uid] == 0): ?>暂无<?php else: echo ($vo["uid"]); endif; ?></td>
