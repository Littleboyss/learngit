  ...
  <div class="common-form">
    <form name="myform" action="" method="post" id="myform">
      <table width="100%" class="table_form contentWrap">
        <tr>
          <td width="80">项目选择</td>
          <td><?php $_result=C('APP_LIST');if(is_array($_result)): $i = 0; $__LIST__ = $_result;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$a): $mod = ($i % 2 );++$i;?><label style="margin-right: 10px"><input name="cache[]" type="checkbox" value="<?php echo ($a); ?>" />&nbsp;<?php echo ($key); ?></label><?php endforeach; endif; else: echo "" ;endif; ?></td>
        </tr>
      </table>
      <div class="bk15"></div>
