...
<div class="subnav">
  <div class="content-menu ib-a blue line-x"> 
    <a href='javascript:;' class="on"><em>版本信息</em></a>
    　|　<a href='<?php echo U('add');?>'><em>发布新版本</em></a>
  </div>
</div>
<div class="pad_10">
  ...
  <?php $platform = array(1=>'安卓',2=>'IOS'); ?>
    ...
    <?php if(is_array($data)): foreach($data as $key=>$vo): ?><tr align='left'>
      ...
      <td align="center"><?php echo ($platform[$vo[platform]]); ?></td>
      ...
      <td align="center">
          ...
          &nbsp;
          <a href="<?php echo U('del', array('id' => $vo['id']));?>" onclick="return confirm('你确定删除该版本？')">删除</a>
      </td>
