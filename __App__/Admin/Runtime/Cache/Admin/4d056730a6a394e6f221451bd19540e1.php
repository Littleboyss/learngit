...
<div class="subnav">
  <div class="content-menu ib-a blue line-x"> <a href='javascript:;' class="on"><em>激活码</em></a>
    　|　<a href="<?php echo U('add');?>"><em>添加</em></a>
  </div>
</div>
<div class="pad_10">
  ...
  <thead>
    ...
    <tr align='left'>
      <td align="center">--</td>
      <td align="center">内部测试用</td>
      <td align="center">--</td>
      <td align="center">
        <a href="<?php echo U('show', array('cid'=>0));?>">查看</a>
        <a href="<?php echo U('create', array('cid'=>0));?>">生成100个</a>
        <a href="<?php echo U('download', array('cid'=>0));?>"><em>导出</em></a>
      </td>
    </tr>
    <?php if(is_array($data)): foreach($data as $key=>$vo): ?><tr align='left'>
      ...
      <td align="center">
        <a href="<?php echo U('show', array('cid'=>$vo['id']));?>">查看</a>
        <a href="<?php echo U('edit', array('id'=>$vo['id']));?>">修改</a>
        <a href="<?php echo U('download', array('cid'=>$vo['id']));?>"><em>导出</em></a>
        <a href="<?php echo U('create', array('cid'=>$vo['id']));?>">生成100个</a>
