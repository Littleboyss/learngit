...
<div class="subnav">
  <div class="content-menu ib-a blue line-x">
    <a href='javascript:;' class="on"><em>帮助列表</em></a>
    <span>|</span>
    <a href="<?php echo U('add');?>"><em>添加帮助</em></a>
    <span>|</span>
...
<div class="pad_10">
  ...
  <thead>
    ...
    <?php if(is_array($data)): foreach($data as $key=>$vo): ?><tr align='left'>
      ...
      <td align="center"><input name="sort" type="text" dataid="<?php echo ($vo["id"]); ?>" value="<?php echo ($vo["sort"]); ?>" style="width:20px;" /><span></span></td>
      <td align="center"><?php echo ($vo["author"]); ?></td>
      <td align="center"><?php if($vo["modify_time"] == 0): ?>暂无<?php else: echo (date("Y-m-d H:i",$vo["modify_time"])); endif; ?></td>
