...
<div class="subnav">
  <div class="content-menu ib-a blue line-x">
    ...
    <span>|</span>
    <a href="<?php echo U('add');?>"><em>商品分类添加</em></a>
  </div>
  </div>
</div>
<div class="pad_10">
  ...
  <thead>
    ...
    <?php if(is_array($data)): foreach($data as $key=>$vo): ?><tr align='left'>
      ...
      <td align="center"><?php  if ($vo['update_time'] == 0) { echo '暂无'; }else{ echo date("Y-m-d H:i",$vo['update_time']); } ?>
        </td>    
      <td width="22%" align="center">
          <a href="<?php echo U('edit', array('id' => $vo['id']));?>">修改</a>
          &nbsp;
          <a href="<?php echo U('del', array('id' => $vo['id']));?>" onclick="return confirm('你确定删除该分类？')">删除</a>
      </td>
