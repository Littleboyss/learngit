...
<div class="subnav">
  <div class="content-menu ib-a blue line-x"> <a href='javascript:;' class="on"><em>公告列表</em></a>
    <span>|</span><a href="<?php echo U('add');?>"><em>添加公告</em></a> </div>
  </div>
</div>
<div class="pad_10">
  <div class="table-list">
    ...
    <tr>
      <td width="230">
        标题:<input  name="title" type="text" class="input-text">
      </td>
       <td>
