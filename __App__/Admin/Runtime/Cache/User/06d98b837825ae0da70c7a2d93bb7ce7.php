...
<div class="subnav">
    ...
    <a href='javascript:;' class="on"><em>添加公告</em></a>
    <span>|</span>
                ...
                <table width='98%' border='0' cellpadding='0' cellspacing='0'
                    ...
                    <tr>
                        ...
                        <td class="tLeft" colspan="3">
                            <input type="text" name="title" value="" class="sm input-text" />
                        </td>
                    </tr>
                    <tr>
                        <td class="tRight">描述：</td>
                        <td class="tLeft" colspan="3">
                            <input type="text" name="depict" value="" class="sm input-text" />(20字以内)
                        </td>
                    </tr>
                    <tr>
                        <td class="tRight">公告内容：</td>
                        <td class="tLeft" colspan="3">
                            <textarea name="notice" id="background"  ></textarea>
                        </td>
                    </tr>
                    <tr>
                        <td class="center"></td>
