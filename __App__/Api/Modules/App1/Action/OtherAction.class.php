...
class OtherAction extends CommonAction{
    ...
    public function room_menu(){
    	...
    	$data[0] = array(
    		...
    		'name' =>'NBA房',
    		'children_menu' => array(
    			0 => array('name' => '全部','type' => 3,'id' => 0),
    			1 => array('name' => '5人房','type' => 2,'id' => 2),
    			2 => array('name' => '8人房','type' => 2,'id' => 4),
    			3 => array('name' => '主播房','type' => 2,'id' => 5)
    		));
    	$data[1] = array(
    		'type' => 1,
    		'id' => '5,6',
    		...
    		'children_menu' => array(
    			0 => array('name' => '全部','type' => 3,'id' => 0),
    			1 => array('name' => 'LOL房','type' => 1,'id' => 5),
    			2 => array('name' => 'DOTA2房','type' => 1,'id' => 6),
    			3 => array('name' => '活动房','type' => 2,'id' => 3)
    		));
    	$data[2] = array(
    		'type' => 2,
    		'id' => 4,
    		...
    		'children_menu' => array(
    			0 => array('name' => '全部','type' => 3,'id' => 0),
    			1 => array('name' => 'LOL房','type' => 1,'id' => 4),
    			2 => array('name' => 'DOTA2房','type' => 1,'id' => 5),
    			3 => array('name' => 'NBA房','type' => 1,'id' => 6)
    		));
    ...
    public function goodsdetail(){
    	...
    	$data = M('ShopGoods')->where(array('id' => $id))->find();
    	if(!$data){
    		exit('商品不存在');
    	}
